...
TOKEN_CHECKS: tuple[TokenCheck, ...] = (
    ...
    TokenCheck(
        ...
        (
            ...
            "--upsert-json smoke-input/retry-upsert.json",
            "--delete-json smoke-input/retry-delete.json",
            "Retry-safe mutation metadata served proof",
            "retry-safe-served-smoke-diagnostics",
        ),
    ),
    TokenCheck(
        "served DataBroker proof input generator feeds retry-safe proof",
        "scripts/write_databroker_served_smoke_inputs.py",
        (
            "retry-upsert.json",
            "retry-delete.json",
...
""",
    ...
    token_files = {
        ...
        "scripts/write_databroker_served_smoke_inputs.py": 'retry-upsert.json\nretry-delete.json\nMESSAGE_TYPE = "udb.sdk.live.v1.SdkLiveRecord"\nauth.authenticate_bearer(login.access_token)',
    }
