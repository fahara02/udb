...
TOKEN_CHECKS: tuple[TokenCheck, ...] = (
    ...
    TokenCheck(
        "shared catalog project resolver uses typed policy detail",
        "src/runtime/service/handlers_catalog.rs",
        (
            "fn request_has_explicit_catalog_platform_authority(",
            "pub(crate) fn resolve_catalog_mutation_project(",
            "service_policy_denied(",
            '"catalog_project_scope_mismatch"',
            '"udb:platform_admin"',
            "catalog_project_resolution_defaults_and_denies_cross_project_without_platform_scope",
            "decode_detail(&denied)",
            "ErrorKind::Policy",
