...
<p align="center">
  ...
  <sub>gRPC data plane | native control plane | tenant/project scope guard<br>crate v0.4.15 | protocol v1.0.0</sub>
</p>
...
| Release | crate/SDK version `0.4.15`, wire protocol `1.0.0` |
...
| Language | Install |
|---|---|
| Go | `go get github.com/fahara02/udb/sdk/go@v0.4.15` |
| Python | `pip install udb-client==0.4.15` |
| TypeScript / Node | `npm i @udb_plus/sdk@0.4.15` |
| PHP / Laravel | `composer require fahara02/udb-laravel:^0.4.15` |
| C# | `dotnet add package Udb.Client --version 0.4.15` |
| Java | `dev.udb:udb-java-client` (`0.4.15` target; build from checkout until publishing lands) |
