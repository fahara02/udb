...
<p align="center">
  ...
  <sub>gRPC data plane | native control plane | tenant/project scope guard<br>crate v0.5.12 | protocol v1.0.0</sub>
</p>
...
| Native control plane | 27 services, 302 RPCs |
...
| Release | crate/SDK version `0.5.12`, wire protocol `1.0.0` |
...
| Language | Install |
|---|---|
| Go | `go get github.com/fahara02/udb/sdk/go@v0.5.12` |
| Python | `pip install udb-client==0.5.12` |
| TypeScript / Node | `npm i @udb_plus/sdk@0.5.12` |
| PHP / Laravel | `composer require fahara02/udb-laravel:^0.5.12` |
| C# | `dotnet add package Udb.Client --version 0.5.12` |
| Java | `dev.udb:udb-java-client` (`0.5.12` target; build from checkout until publishing lands) |
