...
## Quick reference
**Current baseline:** UDB `0.5.19`, wire protocol `1.0.0`. Pin SDKs to the same
product version: TS `@udb_plus/sdk@0.5.19` · Python `udb-client==0.5.19` · Go
`github.com/fahara02/udb/sdk/go@v0.5.19` · Java `dev.udb:udb-java-client`
`0.5.19` · C# `Udb.Client` `0.5.19` · PHP `fahara02/udb-laravel:^0.5.19`.
