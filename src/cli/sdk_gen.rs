...
fn sdk_diff(selector: &SdkSelector, against: &str) -> i32 {
    ...
    {
        eprintln!(
            "sdk diff: {against} was generated by udb {stamped}, this CLI is udb {UDB_PACKAGE_VERSION}.              Regenerate with `udb sdk generate --project-proto {proto_root} --lang go` and commit.              A file produced by a superseded toolchain can be byte-identical in the parts you read and still miss fixes made since."
        );
        return 1;
    }
