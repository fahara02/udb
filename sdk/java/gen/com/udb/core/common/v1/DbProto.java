...
public final class DbProto {
  ...
  static {
    ...
    internal_static_udb_core_common_v1_IndexOptions_IndexParamsEntry_descriptor =
      internal_static_udb_core_common_v1_IndexOptions_descriptor.getNestedTypes().get(0);
    ...
    pgTable.internalInit(descriptor.getExtensions().get(1));
    vectorStore.internalInit(descriptor.getExtensions().get(2));
    cache.internalInit(descriptor.getExtensions().get(3));
    modelRegistry.internalInit(descriptor.getExtensions().get(4));
    graphStore.internalInit(descriptor.getExtensions().get(5));
    documentStore.internalInit(descriptor.getExtensions().get(6));
    nosqlStore.internalInit(descriptor.getExtensions().get(7));
    timeseriesStore.internalInit(descriptor.getExtensions().get(8));
    columnStore.internalInit(descriptor.getExtensions().get(9));
    dataStore.internalInit(descriptor.getExtensions().get(10));
    security.internalInit(descriptor.getExtensions().get(11));
    column.internalInit(descriptor.getExtensions().get(12));
    pgColumn.internalInit(descriptor.getExtensions().get(13));
    storage.internalInit(descriptor.getExtensions().get(14));
    columnSecurity.internalInit(descriptor.getExtensions().get(15));
