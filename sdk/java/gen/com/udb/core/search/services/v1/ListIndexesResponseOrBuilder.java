...
public interface ListIndexesResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:udb.core.search.services.v1.ListIndexesResponse)
   ...
   * <code>repeated .udb.core.search.services.v1.SearchIndexSummary indexes = 1 [json_name = "indexes"];</code>
   */
  com.udb.core.search.services.v1.SearchIndexSummary getIndexes(int index);
  /**
   * <code>repeated .udb.core.search.services.v1.SearchIndexSummary indexes = 1 [json_name = "indexes"];</code>
   */
  int getIndexesCount();
   ...
   * <code>repeated .udb.core.search.services.v1.SearchIndexSummary indexes = 1 [json_name = "indexes"];</code>
   */
  com.udb.core.search.services.v1.SearchIndexSummaryOrBuilder getIndexesOrBuilder(
      int index);
