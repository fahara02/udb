...
public interface ListDeliveriesResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:udb.core.webhook.services.v1.ListDeliveriesResponse)
   ...
   * <code>repeated .udb.core.webhook.entity.v1.WebhookDelivery deliveries = 1 [json_name = "deliveries"];</code>
   */
  com.udb.core.webhook.entity.v1.WebhookDelivery getDeliveries(int index);
  /**
   * <code>repeated .udb.core.webhook.entity.v1.WebhookDelivery deliveries = 1 [json_name = "deliveries"];</code>
   */
   ...
   * <code>repeated .udb.core.webhook.entity.v1.WebhookDelivery deliveries = 1 [json_name = "deliveries"];</code>
   */
  com.udb.core.webhook.entity.v1.WebhookDeliveryOrBuilder getDeliveriesOrBuilder(
      int index);
