...
const file_udb_core_control_services_v1_control_plane_service_proto_rawDesc = "" +
	...
	"\n" +
	"\x13ControlPlaneService\x12\xbc\x01\n" +
	"\x0fStreamResources\x12..udb.core.control.services.v1.DiscoveryRequest\x1a/.udb.core.control.services.v1.DiscoveryResponse\"D\xca\xf3\x18@\b\x02\x1a\x1cudb:control:stream-resourcesJ\x02\x01\x04j\x17control.StreamResources\x90\x01\x01(\x010\x01\x12\xc3\x01\n" +
	"\x0eDeltaResources\x123.udb.core.control.services.v1.DeltaDiscoveryRequest\x1a4.udb.core.control.services.v1.DeltaDiscoveryResponse\"B\xca\xf3\x18>\b\x02\x1a\x1budb:control:delta-resourcesJ\x02\x01\x04j\x16control.DeltaResources\x90\x01\x01(\x010\x01\x12\xd2\x01\n" +
	"\fGetResources\x121.udb.core.control.services.v1.GetResourcesRequest\x1a2.udb.core.control.services.v1.GetResourcesResponse\"[\xca\xf3\x18:\b\x02\x1a\x19udb:control:get-resourcesJ\x02\x01\x04j\x14control.GetResources\x90\x01\x01\x82\xd3\xe4\x93\x02\x17\x12\x15/v1/control/resources\x12\xdf\x01\n" +
	"\x0eListNodeStates\x123.udb.core.control.services.v1.ListNodeStatesRequest\x1a4.udb.core.control.services.v1.ListNodeStatesResponse\"b\xca\xf3\x18?\b\x02\x1a\x1cudb:control:list-node-statesJ\x02\x01\x02j\x16control.ListNodeStates\x90\x01\x01\x82\xd3\xe4\x93\x02\x19\x12\x17/v1/control/node-states\x12\xda\x01\n" +
	"\tAckStatus\x12..udb.core.control.services.v1.AckStatusRequest\x1a/.udb.core.control.services.v1.AckStatusResponse\"l\xca\xf3\x184\b\x02\x1a\x16udb:control:ack-statusJ\x02\x01\x02j\x11control.AckStatus\x90\x01\x01\x82\xd3\xe4\x93\x02.\x12,/v1/control/node-states/{node_id}:ack-status\x1a\xe0\x01\xca\xf0\x19y\n" +
