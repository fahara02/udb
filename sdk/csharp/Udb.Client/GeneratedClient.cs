...
public static class GeneratedRpcIdentities
{
    ...
    private static IReadOnlyDictionary<string, RpcIdentity> Build()
    {
        ...
        map["/udb.core.vault.services.v1.VaultService/BatchDecrypt"] = new RpcIdentity("/udb.core.vault.services.v1.VaultService/BatchDecrypt", "VaultService", "BatchDecrypt", "batch_decrypt", "vaultBatchDecrypt", "mutation", "post", "/v1/vault/transit:batch-decrypt");
        map["/udb.core.vault.services.v1.VaultService/BatchEncrypt"] = new RpcIdentity("/udb.core.vault.services.v1.VaultService/BatchEncrypt", "VaultService", "BatchEncrypt", "batch_encrypt", "vaultBatchEncrypt", "mutation", "post", "/v1/vault/transit:batch-encrypt");
        ...
        map["/udb.core.vault.services.v1.VaultService/GenerateDataKey"] = new RpcIdentity("/udb.core.vault.services.v1.VaultService/GenerateDataKey", "VaultService", "GenerateDataKey", "generate_data_key", "vaultGenerateDataKey", "mutation", "post", "/v1/vault/transit:generate-data-key");
        ...
        map["/udb.core.vault.services.v1.VaultService/GetTransitPublicKey"] = new RpcIdentity("/udb.core.vault.services.v1.VaultService/GetTransitPublicKey", "VaultService", "GetTransitPublicKey", "get_transit_public_key", "vaultGetTransitPublicKey", "read_only", "post", "/v1/vault/transit:public-key");
