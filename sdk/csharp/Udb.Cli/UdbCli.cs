...
//
// UDB CLI launcher (version 0.4.9).
//
...
//   1. an already-installed `udb` on PATH whose `--version` matches 0.4.9;
//   2. a previously cached download under the per-user cache dir;
//   3. otherwise downloads the v0.4.9 release asset for this OS/arch
