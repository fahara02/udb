...
//
// UDB CLI launcher (version 0.5.8).
//
...
//   1. an already-installed `udb` on PATH whose `--version` matches 0.5.8;
//   2. a previously cached download under the per-user cache dir;
//   3. otherwise downloads the v0.5.8 release asset for this OS/arch
