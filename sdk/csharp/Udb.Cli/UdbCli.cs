...
//
// UDB CLI launcher (version 0.4.16).
//
...
//   1. an already-installed `udb` on PATH whose `--version` matches 0.4.16;
//   2. a previously cached download under the per-user cache dir;
//   3. otherwise downloads the v0.4.16 release asset for this OS/arch
