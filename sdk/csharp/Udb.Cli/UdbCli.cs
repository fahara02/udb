...
//
// UDB CLI launcher (version 0.3.7).
//
...
//   1. an already-installed `udb` on PATH whose `--version` matches 0.3.7;
//   2. a previously cached download under the per-user cache dir;
//   3. otherwise downloads the v0.3.7 release asset for this OS/arch
