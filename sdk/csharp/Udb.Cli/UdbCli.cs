...
//
// UDB CLI launcher (version 0.5.10).
//
...
//   1. an already-installed `udb` on PATH whose `--version` matches 0.5.10;
//   2. a previously cached download under the per-user cache dir;
//   3. otherwise downloads the v0.5.10 release asset for this OS/arch
