...
//
// UDB CLI launcher (version 0.4.35).
//
...
//   1. an already-installed `udb` on PATH whose `--version` matches 0.4.35;
//   2. a previously cached download under the per-user cache dir;
//   3. otherwise downloads the v0.4.35 release asset for this OS/arch
...
{
    private const string Version = "0.4.35";
