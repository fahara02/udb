...
//
// UDB CLI launcher (version 0.3.0).
//
...
//
//   dotnet tool install --global Udb.Cli --version 0.3.0
//   udb --help
//
// On launch it resolves the version-matched `udb` binary in this order:
//   1. an already-installed `udb` on PATH whose `--version` matches 0.3.0;
//   2. a previously cached download under the per-user cache dir;
//   3. otherwise downloads the v0.3.0 release asset for this OS/arch
