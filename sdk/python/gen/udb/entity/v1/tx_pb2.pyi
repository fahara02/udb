...
class Mutation(_message.Message):
    __slots__ = ("context", "tx_id", "operation", "message_type", "record_json", "payload", "filter", "collection", "vector_points", "commit", "rollback", "bucket", "object_key", "object_data", "content_type", "idempotency_key")
...
class TxStatus(_message.Message):
    ...
    mutation_id: str
    message: str
    def __init__(self, state: _Optional[_Union[TxStatus.State, str]] = ..., tx_id: _Optional[str] = ..., mutation_id: _Optional[str] = ..., message: _Optional[str] = ...) -> None: ...
