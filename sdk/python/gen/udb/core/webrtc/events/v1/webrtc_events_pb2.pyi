...
class EgressStarted(_message.Message):
    __slots__ = ("event_id", "egress_id", "room_id", "track_id", "tenant_id", "kind", "timestamp")
    EVENT_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    kind: str
    timestamp: _timestamp_pb2.Timestamp
    def __init__(self, event_id: _Optional[str] = ..., egress_id: _Optional[str] = ..., room_id: _Optional[str] = ..., track_id: _Optional[str] = ..., tenant_id: _Optional[str] = ..., kind: _Optional[str] = ..., timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...

class EgressStopped(_message.Message):
    __slots__ = ("event_id", "egress_id", "room_id", "tenant_id", "timestamp")
    EVENT_ID_FIELD_NUMBER: _ClassVar[int]
    EGRESS_ID_FIELD_NUMBER: _ClassVar[int]
    ROOM_ID_FIELD_NUMBER: _ClassVar[int]
    TENANT_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    tenant_id: str
    timestamp: _timestamp_pb2.Timestamp
    def __init__(self, event_id: _Optional[str] = ..., egress_id: _Optional[str] = ..., room_id: _Optional[str] = ..., tenant_id: _Optional[str] = ..., timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...

class EgressFailed(_message.Message):
    __slots__ = ("event_id", "egress_id", "room_id", "tenant_id", "reason", "timestamp")
    EVENT_ID_FIELD_NUMBER: _ClassVar[int]
    EGRESS_ID_FIELD_NUMBER: _ClassVar[int]
    ROOM_ID_FIELD_NUMBER: _ClassVar[int]
    TENANT_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    reason: str
    timestamp: _timestamp_pb2.Timestamp
    def __init__(self, event_id: _Optional[str] = ..., egress_id: _Optional[str] = ..., room_id: _Optional[str] = ..., tenant_id: _Optional[str] = ..., reason: _Optional[str] = ..., timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
