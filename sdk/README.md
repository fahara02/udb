...
|---|---|---|
| Go | `github.com/fahara02/udb/sdk/go` | `go get github.com/fahara02/udb/sdk/go@v0.4.4` |
| Python | `udb-client` | `pip install udb-client==0.4.4` |
| TypeScript / Node | `@udb_plus/sdk` | `npm i @udb_plus/sdk@0.4.4` |
| PHP / Laravel | `fahara02/udb-laravel` | `composer require fahara02/udb-laravel:^0.4.4` |
| C# | `Udb.Client` | `dotnet add package Udb.Client --version 0.4.4` |
...
```bash
composer require fahara02/udb-laravel:^0.4.4
```
