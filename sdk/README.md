...
|---|---|---|
| Go | `github.com/fahara02/udb/sdk/go` | `go get github.com/fahara02/udb/sdk/go@v0.4.29` |
| Python | `udb-client` | `pip install udb-client==0.4.29` |
| TypeScript / Node | `@udb_plus/sdk` | `npm i @udb_plus/sdk@0.4.29` |
| PHP / Laravel | `fahara02/udb-laravel` | `composer require fahara02/udb-laravel:^0.4.29` |
| C# | `Udb.Client` | `dotnet add package Udb.Client --version 0.4.29` |
...
```bash
composer require fahara02/udb-laravel:^0.4.29
```
