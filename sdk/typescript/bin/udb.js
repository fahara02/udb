...
//
// Version-matched `udb` CLI launcher bundled with @udb_plus/sdk v0.4.17.
//
// Resolution order:
//   1. $UDB_BIN, if set and executable, is used verbatim.
//   2. A `udb` already on PATH whose `--version` matches v0.4.17 is used.
//   3. Otherwise the matching raw release binary is downloaded once from
//      github.com/fahara02/udb (tag v0.4.17, asset `udb-<os>-<arch>[-<variant>][.exe]`)
//      into a per-user cache dir and executed thereafter.
//
// The downloaded binary is cached at:
//   $UDB_CACHE_DIR || <os-cache>/udb/v0.4.17/udb[.exe]
"use strict";
