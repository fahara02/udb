...
export const UDB_SDK_VERSION = "0.3.2";
...
function isReadOnlyRpcName(name: string): boolean {
  return [
    "Get",
    "List",
    "Check",
...
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  ...
  api.get_executor_performance = (request: any, call?: CallOptions) =>
    core.unary("udb.core.analytics.services.v1.AnalyticsService", "GetExecutorPerformance", request, isReadOnlyRpcName("GetExecutorPerformance"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.analytics.services.v1.AnalyticsService") return;
  api.get_pipeline_summary = (request: any, call?: CallOptions) =>
    core.unary("udb.core.analytics.services.v1.AnalyticsService", "GetPipelineSummary", request, isReadOnlyRpcName("GetPipelineSummary"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.analytics.services.v1.AnalyticsService") return;
  api.get_reconciliation_analytics = (request: any, call?: CallOptions) =>
    core.unary("udb.core.analytics.services.v1.AnalyticsService", "GetReconciliationAnalytics", request, isReadOnlyRpcName("GetReconciliationAnalytics"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.analytics.services.v1.AnalyticsService") return;
  api.get_sla_compliance = (request: any, call?: CallOptions) =>
    core.unary("udb.core.analytics.services.v1.AnalyticsService", "GetSlaCompliance", request, isReadOnlyRpcName("GetSlaCompliance"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.analytics.services.v1.AnalyticsService") return;
  api.get_throughput = (request: any, call?: CallOptions) =>
    core.unary("udb.core.analytics.services.v1.AnalyticsService", "GetThroughput", request, isReadOnlyRpcName("GetThroughput"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.analytics.services.v1.AnalyticsService") return;
  api.record_pipeline_metric = (request: any, call?: CallOptions) =>
    core.unary("udb.core.analytics.services.v1.AnalyticsService", "RecordPipelineMetric", request, isReadOnlyRpcName("RecordPipelineMetric"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.analytics.services.v1.AnalyticsService") return;
  api.trigger_snapshot = (request: any, call?: CallOptions) =>
    core.unary("udb.core.analytics.services.v1.AnalyticsService", "TriggerSnapshot", request, isReadOnlyRpcName("TriggerSnapshot"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.apikey.services.v1.ApiKeyService") return;
  api.create_api_key = (request: any, call?: CallOptions) =>
    core.unary("udb.core.apikey.services.v1.ApiKeyService", "CreateApiKey", request, isReadOnlyRpcName("CreateApiKey"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.apikey.services.v1.ApiKeyService") return;
  api.emergency_revoke_api_keys = (request: any, call?: CallOptions) =>
    core.unary("udb.core.apikey.services.v1.ApiKeyService", "EmergencyRevokeApiKeys", request, isReadOnlyRpcName("EmergencyRevokeApiKeys"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.apikey.services.v1.ApiKeyService") return;
  api.get_api_key = (request: any, call?: CallOptions) =>
    core.unary("udb.core.apikey.services.v1.ApiKeyService", "GetApiKey", request, isReadOnlyRpcName("GetApiKey"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.apikey.services.v1.ApiKeyService") return;
  api.get_api_key_usage_stats = (request: any, call?: CallOptions) =>
    core.unary("udb.core.apikey.services.v1.ApiKeyService", "GetApiKeyUsageStats", request, isReadOnlyRpcName("GetApiKeyUsageStats"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.apikey.services.v1.ApiKeyService") return;
  api.list_api_keys = (request: any, call?: CallOptions) =>
    core.unary("udb.core.apikey.services.v1.ApiKeyService", "ListApiKeys", request, isReadOnlyRpcName("ListApiKeys"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.apikey.services.v1.ApiKeyService") return;
  api.revoke_api_key = (request: any, call?: CallOptions) =>
    core.unary("udb.core.apikey.services.v1.ApiKeyService", "RevokeApiKey", request, isReadOnlyRpcName("RevokeApiKey"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.apikey.services.v1.ApiKeyService") return;
  api.rotate_api_key = (request: any, call?: CallOptions) =>
    core.unary("udb.core.apikey.services.v1.ApiKeyService", "RotateApiKey", request, isReadOnlyRpcName("RotateApiKey"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.apikey.services.v1.ApiKeyService") return;
  api.update_api_key = (request: any, call?: CallOptions) =>
    core.unary("udb.core.apikey.services.v1.ApiKeyService", "UpdateApiKey", request, isReadOnlyRpcName("UpdateApiKey"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.apikey.services.v1.ApiKeyService") return;
  api.validate_api_key = (request: any, call?: CallOptions) =>
    core.unary("udb.core.apikey.services.v1.ApiKeyService", "ValidateApiKey", request, isReadOnlyRpcName("ValidateApiKey"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.asset.services.v1.AssetService") return;
  api.complete_step = (request: any, call?: CallOptions) =>
    core.unary("udb.core.asset.services.v1.AssetService", "CompleteStep", request, isReadOnlyRpcName("CompleteStep"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.asset.services.v1.AssetService") return;
  api.create_pipeline_definition = (request: any, call?: CallOptions) =>
    core.unary("udb.core.asset.services.v1.AssetService", "CreatePipelineDefinition", request, isReadOnlyRpcName("CreatePipelineDefinition"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.asset.services.v1.AssetService") return;
  api.get_asset = (request: any, call?: CallOptions) =>
    core.unary("udb.core.asset.services.v1.AssetService", "GetAsset", request, isReadOnlyRpcName("GetAsset"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.asset.services.v1.AssetService") return;
  api.get_pipeline = (request: any, call?: CallOptions) =>
    core.unary("udb.core.asset.services.v1.AssetService", "GetPipeline", request, isReadOnlyRpcName("GetPipeline"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.asset.services.v1.AssetService") return;
  api.get_pipeline_definition = (request: any, call?: CallOptions) =>
    core.unary("udb.core.asset.services.v1.AssetService", "GetPipelineDefinition", request, isReadOnlyRpcName("GetPipelineDefinition"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.asset.services.v1.AssetService") return;
  api.list_assets = (request: any, call?: CallOptions) =>
    core.unary("udb.core.asset.services.v1.AssetService", "ListAssets", request, isReadOnlyRpcName("ListAssets"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.asset.services.v1.AssetService") return;
  api.register_asset = (request: any, call?: CallOptions) =>
    core.unary("udb.core.asset.services.v1.AssetService", "RegisterAsset", request, isReadOnlyRpcName("RegisterAsset"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.asset.services.v1.AssetService") return;
  api.start_pipeline = (request: any, call?: CallOptions) =>
    core.unary("udb.core.asset.services.v1.AssetService", "StartPipeline", request, isReadOnlyRpcName("StartPipeline"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.admin_reset_mfa = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "AdminResetMfa", request, isReadOnlyRpcName("AdminResetMfa"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.admin_reset_password = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "AdminResetPassword", request, isReadOnlyRpcName("AdminResetPassword"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.admin_revoke_all_tenant_sessions = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "AdminRevokeAllTenantSessions", request, isReadOnlyRpcName("AdminRevokeAllTenantSessions"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.admin_revoke_all_user_sessions = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "AdminRevokeAllUserSessions", request, isReadOnlyRpcName("AdminRevokeAllUserSessions"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.admin_revoke_session = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "AdminRevokeSession", request, isReadOnlyRpcName("AdminRevokeSession"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.authenticate = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "Authenticate", request, isReadOnlyRpcName("Authenticate"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.change_password = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "ChangePassword", request, isReadOnlyRpcName("ChangePassword"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.change_user_status = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "ChangeUserStatus", request, isReadOnlyRpcName("ChangeUserStatus"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.confirm_m_f_a_enrollment = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "ConfirmMFAEnrollment", request, isReadOnlyRpcName("ConfirmMFAEnrollment"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.create_session = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "CreateSession", request, isReadOnlyRpcName("CreateSession"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.create_user = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "CreateUser", request, isReadOnlyRpcName("CreateUser"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.delete_web_authn_credential = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "DeleteWebAuthnCredential", request, isReadOnlyRpcName("DeleteWebAuthnCredential"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.disable_mfa_factor = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "DisableMfaFactor", request, isReadOnlyRpcName("DisableMfaFactor"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.emergency_revoke = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "EmergencyRevoke", request, isReadOnlyRpcName("EmergencyRevoke"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.enroll_m_f_a = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "EnrollMFA", request, isReadOnlyRpcName("EnrollMFA"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.finish_web_authn_authentication = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "FinishWebAuthnAuthentication", request, isReadOnlyRpcName("FinishWebAuthnAuthentication"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.finish_web_authn_registration = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "FinishWebAuthnRegistration", request, isReadOnlyRpcName("FinishWebAuthnRegistration"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.forgot_password = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "ForgotPassword", request, isReadOnlyRpcName("ForgotPassword"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.generate_recovery_codes = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "GenerateRecoveryCodes", request, isReadOnlyRpcName("GenerateRecoveryCodes"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.get_jwks = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "GetJwks", request, isReadOnlyRpcName("GetJwks"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.get_mfa_policy = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "GetMfaPolicy", request, isReadOnlyRpcName("GetMfaPolicy"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.get_session = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "GetSession", request, isReadOnlyRpcName("GetSession"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.get_user = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "GetUser", request, isReadOnlyRpcName("GetUser"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.introspect_token = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "IntrospectToken", request, isReadOnlyRpcName("IntrospectToken"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.issue_mfa_challenge = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "IssueMfaChallenge", request, isReadOnlyRpcName("IssueMfaChallenge"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.list_devices = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "ListDevices", request, isReadOnlyRpcName("ListDevices"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.list_mfa_factors = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "ListMfaFactors", request, isReadOnlyRpcName("ListMfaFactors"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.list_sessions = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "ListSessions", request, isReadOnlyRpcName("ListSessions"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.list_users = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "ListUsers", request, isReadOnlyRpcName("ListUsers"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.list_web_authn_credentials = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "ListWebAuthnCredentials", request, isReadOnlyRpcName("ListWebAuthnCredentials"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.login = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "Login", request, isReadOnlyRpcName("Login"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.logout = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "Logout", request, isReadOnlyRpcName("Logout"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.put_mfa_policy = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "PutMfaPolicy", request, isReadOnlyRpcName("PutMfaPolicy"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.refresh_session = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "RefreshSession", request, isReadOnlyRpcName("RefreshSession"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.refresh_token = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "RefreshToken", request, isReadOnlyRpcName("RefreshToken"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.rename_passkey = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "RenamePasskey", request, isReadOnlyRpcName("RenamePasskey"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.resend_o_t_p = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "ResendOTP", request, isReadOnlyRpcName("ResendOTP"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.reset_password = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "ResetPassword", request, isReadOnlyRpcName("ResetPassword"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.revoke_device = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "RevokeDevice", request, isReadOnlyRpcName("RevokeDevice"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.revoke_recovery_codes = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "RevokeRecoveryCodes", request, isReadOnlyRpcName("RevokeRecoveryCodes"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.revoke_session = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "RevokeSession", request, isReadOnlyRpcName("RevokeSession"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.send_o_t_p = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "SendOTP", request, isReadOnlyRpcName("SendOTP"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.send_phone_verification = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "SendPhoneVerification", request, isReadOnlyRpcName("SendPhoneVerification"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.start_web_authn_authentication = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "StartWebAuthnAuthentication", request, isReadOnlyRpcName("StartWebAuthnAuthentication"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.start_web_authn_registration = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "StartWebAuthnRegistration", request, isReadOnlyRpcName("StartWebAuthnRegistration"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.update_user = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "UpdateUser", request, isReadOnlyRpcName("UpdateUser"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.validate_c_s_r_f = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "ValidateCSRF", request, isReadOnlyRpcName("ValidateCSRF"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.validate_token = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "ValidateToken", request, isReadOnlyRpcName("ValidateToken"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.verify_mfa_challenge = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "VerifyMfaChallenge", request, isReadOnlyRpcName("VerifyMfaChallenge"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authn.services.v1.AuthnService") return;
  api.verify_o_t_p = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authn.services.v1.AuthnService", "VerifyOTP", request, isReadOnlyRpcName("VerifyOTP"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.activate_canary = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "ActivateCanary", request, isReadOnlyRpcName("ActivateCanary"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.activate_policy_version = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "ActivatePolicyVersion", request, isReadOnlyRpcName("ActivatePolicyVersion"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.approve_policy_draft = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "ApprovePolicyDraft", request, isReadOnlyRpcName("ApprovePolicyDraft"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.assign_role = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "AssignRole", request, isReadOnlyRpcName("AssignRole"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.authorize = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "Authorize", request, isReadOnlyRpcName("Authorize"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.batch_check_permissions = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "BatchCheckPermissions", request, isReadOnlyRpcName("BatchCheckPermissions"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.check_access = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "CheckAccess", request, isReadOnlyRpcName("CheckAccess"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.create_policy_draft = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "CreatePolicyDraft", request, isReadOnlyRpcName("CreatePolicyDraft"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.create_policy_rule = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "CreatePolicyRule", request, isReadOnlyRpcName("CreatePolicyRule"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.create_role = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "CreateRole", request, isReadOnlyRpcName("CreateRole"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.delete_policy_rule = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "DeletePolicyRule", request, isReadOnlyRpcName("DeletePolicyRule"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.delete_role = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "DeleteRole", request, isReadOnlyRpcName("DeleteRole"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.diff_policy_draft = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "DiffPolicyDraft", request, isReadOnlyRpcName("DiffPolicyDraft"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.explain_policy = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "ExplainPolicy", request, isReadOnlyRpcName("ExplainPolicy"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.get_authz_revision = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "GetAuthzRevision", request, isReadOnlyRpcName("GetAuthzRevision"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.get_canary_status = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "GetCanaryStatus", request, isReadOnlyRpcName("GetCanaryStatus"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.get_native_access = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "GetNativeAccess", request, isReadOnlyRpcName("GetNativeAccess"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.get_policy_bundle = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "GetPolicyBundle", request, isReadOnlyRpcName("GetPolicyBundle"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.get_policy_rule = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "GetPolicyRule", request, isReadOnlyRpcName("GetPolicyRule"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.get_role = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "GetRole", request, isReadOnlyRpcName("GetRole"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.invalidate_policy_bundles = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "InvalidatePolicyBundles", request, isReadOnlyRpcName("InvalidatePolicyBundles"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.lint_authz_policies = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "LintAuthzPolicies", request, isReadOnlyRpcName("LintAuthzPolicies"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.list_access_decision_audits = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "ListAccessDecisionAudits", request, isReadOnlyRpcName("ListAccessDecisionAudits"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.list_policy_rules = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "ListPolicyRules", request, isReadOnlyRpcName("ListPolicyRules"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.list_policy_versions = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "ListPolicyVersions", request, isReadOnlyRpcName("ListPolicyVersions"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.list_roles = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "ListRoles", request, isReadOnlyRpcName("ListRoles"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.list_user_permissions = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "ListUserPermissions", request, isReadOnlyRpcName("ListUserPermissions"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.list_user_roles = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "ListUserRoles", request, isReadOnlyRpcName("ListUserRoles"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.migrate_legacy_policies = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "MigrateLegacyPolicies", request, isReadOnlyRpcName("MigrateLegacyPolicies"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.promote_canary = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "PromoteCanary", request, isReadOnlyRpcName("PromoteCanary"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.put_authz_policy = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "PutAuthzPolicy", request, isReadOnlyRpcName("PutAuthzPolicy"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.put_relationship = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "PutRelationship", request, isReadOnlyRpcName("PutRelationship"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.put_role_binding = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "PutRoleBinding", request, isReadOnlyRpcName("PutRoleBinding"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.reject_policy_draft = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "RejectPolicyDraft", request, isReadOnlyRpcName("RejectPolicyDraft"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.revoke_role = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "RevokeRole", request, isReadOnlyRpcName("RevokeRole"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.rollback_policy_version = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "RollbackPolicyVersion", request, isReadOnlyRpcName("RollbackPolicyVersion"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.seed_builtin_roles = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "SeedBuiltinRoles", request, isReadOnlyRpcName("SeedBuiltinRoles"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.simulate_policy = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "SimulatePolicy", request, isReadOnlyRpcName("SimulatePolicy"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.submit_policy_draft = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "SubmitPolicyDraft", request, isReadOnlyRpcName("SubmitPolicyDraft"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.update_policy_draft = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "UpdatePolicyDraft", request, isReadOnlyRpcName("UpdatePolicyDraft"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.authz.services.v1.AuthzService") return;
  api.update_role = (request: any, call?: CallOptions) =>
    core.unary("udb.core.authz.services.v1.AuthzService", "UpdateRole", request, isReadOnlyRpcName("UpdateRole"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.control.services.v1.ControlPlaneService") return;
  api.ack_status = (request: any, call?: CallOptions) =>
    core.unary("udb.core.control.services.v1.ControlPlaneService", "AckStatus", request, isReadOnlyRpcName("AckStatus"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.control.services.v1.ControlPlaneService") return;
  api.get_resources = (request: any, call?: CallOptions) =>
    core.unary("udb.core.control.services.v1.ControlPlaneService", "GetResources", request, isReadOnlyRpcName("GetResources"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.control.services.v1.ControlPlaneService") return;
  api.list_node_states = (request: any, call?: CallOptions) =>
    core.unary("udb.core.control.services.v1.ControlPlaneService", "ListNodeStates", request, isReadOnlyRpcName("ListNodeStates"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  ...
  api.create_provider = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "CreateProvider", request, isReadOnlyRpcName("CreateProvider"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.disable_provider = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "DisableProvider", request, isReadOnlyRpcName("DisableProvider"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.force_jwks_refresh = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "ForceJwksRefresh", request, isReadOnlyRpcName("ForceJwksRefresh"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.get_provider = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "GetProvider", request, isReadOnlyRpcName("GetProvider"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.import_saml_metadata = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "ImportSamlMetadata", request, isReadOnlyRpcName("ImportSamlMetadata"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.link_identity = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "LinkIdentity", request, isReadOnlyRpcName("LinkIdentity"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.list_external_identities = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "ListExternalIdentities", request, isReadOnlyRpcName("ListExternalIdentities"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.list_providers = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "ListProviders", request, isReadOnlyRpcName("ListProviders"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.preview_claim_mapping = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "PreviewClaimMapping", request, isReadOnlyRpcName("PreviewClaimMapping"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.preview_group_mapping = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "PreviewGroupMapping", request, isReadOnlyRpcName("PreviewGroupMapping"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.resolve_external_identity = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "ResolveExternalIdentity", request, isReadOnlyRpcName("ResolveExternalIdentity"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.saml_acs = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "SamlAcs", request, isReadOnlyRpcName("SamlAcs"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.scim_create_group = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "ScimCreateGroup", request, isReadOnlyRpcName("ScimCreateGroup"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.scim_create_user = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "ScimCreateUser", request, isReadOnlyRpcName("ScimCreateUser"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.scim_delete_group = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "ScimDeleteGroup", request, isReadOnlyRpcName("ScimDeleteGroup"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.scim_delete_user = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "ScimDeleteUser", request, isReadOnlyRpcName("ScimDeleteUser"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.scim_get_group = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "ScimGetGroup", request, isReadOnlyRpcName("ScimGetGroup"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.scim_get_user = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "ScimGetUser", request, isReadOnlyRpcName("ScimGetUser"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.scim_list_groups = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "ScimListGroups", request, isReadOnlyRpcName("ScimListGroups"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.scim_list_users = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "ScimListUsers", request, isReadOnlyRpcName("ScimListUsers"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.scim_patch_group = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "ScimPatchGroup", request, isReadOnlyRpcName("ScimPatchGroup"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.scim_patch_user = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "ScimPatchUser", request, isReadOnlyRpcName("ScimPatchUser"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.scim_replace_user = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "ScimReplaceUser", request, isReadOnlyRpcName("ScimReplaceUser"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.start_saml_login = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "StartSamlLogin", request, isReadOnlyRpcName("StartSamlLogin"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.test_provider_discovery = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "TestProviderDiscovery", request, isReadOnlyRpcName("TestProviderDiscovery"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.unlink_identity = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "UnlinkIdentity", request, isReadOnlyRpcName("UnlinkIdentity"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.idp.services.v1.IdentityProviderService") return;
  api.update_provider = (request: any, call?: CallOptions) =>
    core.unary("udb.core.idp.services.v1.IdentityProviderService", "UpdateProvider", request, isReadOnlyRpcName("UpdateProvider"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  ...
  api.get_delivery_stats = (request: any, call?: CallOptions) =>
    core.unary("udb.core.notification.services.v1.NotificationService", "GetDeliveryStats", request, isReadOnlyRpcName("GetDeliveryStats"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.notification.services.v1.NotificationService") return;
  api.get_notification = (request: any, call?: CallOptions) =>
    core.unary("udb.core.notification.services.v1.NotificationService", "GetNotification", request, isReadOnlyRpcName("GetNotification"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.notification.services.v1.NotificationService") return;
  api.get_preference = (request: any, call?: CallOptions) =>
    core.unary("udb.core.notification.services.v1.NotificationService", "GetPreference", request, isReadOnlyRpcName("GetPreference"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.notification.services.v1.NotificationService") return;
  api.get_template = (request: any, call?: CallOptions) =>
    core.unary("udb.core.notification.services.v1.NotificationService", "GetTemplate", request, isReadOnlyRpcName("GetTemplate"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.notification.services.v1.NotificationService") return;
  api.list_notifications = (request: any, call?: CallOptions) =>
    core.unary("udb.core.notification.services.v1.NotificationService", "ListNotifications", request, isReadOnlyRpcName("ListNotifications"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.notification.services.v1.NotificationService") return;
  api.list_preferences = (request: any, call?: CallOptions) =>
    core.unary("udb.core.notification.services.v1.NotificationService", "ListPreferences", request, isReadOnlyRpcName("ListPreferences"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.notification.services.v1.NotificationService") return;
  api.list_templates = (request: any, call?: CallOptions) =>
    core.unary("udb.core.notification.services.v1.NotificationService", "ListTemplates", request, isReadOnlyRpcName("ListTemplates"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.notification.services.v1.NotificationService") return;
  api.retry_notification = (request: any, call?: CallOptions) =>
    core.unary("udb.core.notification.services.v1.NotificationService", "RetryNotification", request, isReadOnlyRpcName("RetryNotification"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.notification.services.v1.NotificationService") return;
  api.send_notification = (request: any, call?: CallOptions) =>
    core.unary("udb.core.notification.services.v1.NotificationService", "SendNotification", request, isReadOnlyRpcName("SendNotification"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.notification.services.v1.NotificationService") return;
  api.set_preference = (request: any, call?: CallOptions) =>
    core.unary("udb.core.notification.services.v1.NotificationService", "SetPreference", request, isReadOnlyRpcName("SetPreference"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.notification.services.v1.NotificationService") return;
  api.upsert_template = (request: any, call?: CallOptions) =>
    core.unary("udb.core.notification.services.v1.NotificationService", "UpsertTemplate", request, isReadOnlyRpcName("UpsertTemplate"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.storage.services.v1.StorageService") return;
  api.delete_file = (request: any, call?: CallOptions) =>
    core.unary("udb.core.storage.services.v1.StorageService", "DeleteFile", request, isReadOnlyRpcName("DeleteFile"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.storage.services.v1.StorageService") return;
  api.finalize_upload = (request: any, call?: CallOptions) =>
    core.unary("udb.core.storage.services.v1.StorageService", "FinalizeUpload", request, isReadOnlyRpcName("FinalizeUpload"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.storage.services.v1.StorageService") return;
  api.get_download_url = (request: any, call?: CallOptions) =>
    core.unary("udb.core.storage.services.v1.StorageService", "GetDownloadUrl", request, isReadOnlyRpcName("GetDownloadUrl"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.storage.services.v1.StorageService") return;
  api.get_file = (request: any, call?: CallOptions) =>
    core.unary("udb.core.storage.services.v1.StorageService", "GetFile", request, isReadOnlyRpcName("GetFile"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.storage.services.v1.StorageService") return;
  api.list_files = (request: any, call?: CallOptions) =>
    core.unary("udb.core.storage.services.v1.StorageService", "ListFiles", request, isReadOnlyRpcName("ListFiles"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.storage.services.v1.StorageService") return;
  api.register_upload = (request: any, call?: CallOptions) =>
    core.unary("udb.core.storage.services.v1.StorageService", "RegisterUpload", request, isReadOnlyRpcName("RegisterUpload"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.storage.services.v1.StorageService") return;
  api.update_file = (request: any, call?: CallOptions) =>
    core.unary("udb.core.storage.services.v1.StorageService", "UpdateFile", request, isReadOnlyRpcName("UpdateFile"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.tenant.services.v1.TenantService") return;
  api.create_tenant = (request: any, call?: CallOptions) =>
    core.unary("udb.core.tenant.services.v1.TenantService", "CreateTenant", request, isReadOnlyRpcName("CreateTenant"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.tenant.services.v1.TenantService") return;
  api.get_tenant = (request: any, call?: CallOptions) =>
    core.unary("udb.core.tenant.services.v1.TenantService", "GetTenant", request, isReadOnlyRpcName("GetTenant"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.tenant.services.v1.TenantService") return;
  api.get_tenant_config = (request: any, call?: CallOptions) =>
    core.unary("udb.core.tenant.services.v1.TenantService", "GetTenantConfig", request, isReadOnlyRpcName("GetTenantConfig"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.tenant.services.v1.TenantService") return;
  api.list_tenants = (request: any, call?: CallOptions) =>
    core.unary("udb.core.tenant.services.v1.TenantService", "ListTenants", request, isReadOnlyRpcName("ListTenants"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.tenant.services.v1.TenantService") return;
  api.update_tenant = (request: any, call?: CallOptions) =>
    core.unary("udb.core.tenant.services.v1.TenantService", "UpdateTenant", request, isReadOnlyRpcName("UpdateTenant"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.tenant.services.v1.TenantService") return;
  api.update_tenant_config = (request: any, call?: CallOptions) =>
    core.unary("udb.core.tenant.services.v1.TenantService", "UpdateTenantConfig", request, isReadOnlyRpcName("UpdateTenantConfig"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.webrtc.services.v1.PeerService") return;
  api.get_peer = (request: any, call?: CallOptions) =>
    core.unary("udb.core.webrtc.services.v1.PeerService", "GetPeer", request, isReadOnlyRpcName("GetPeer"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.webrtc.services.v1.PeerService") return;
  api.join_room = (request: any, call?: CallOptions) =>
    core.unary("udb.core.webrtc.services.v1.PeerService", "JoinRoom", request, isReadOnlyRpcName("JoinRoom"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.webrtc.services.v1.PeerService") return;
  api.leave_room = (request: any, call?: CallOptions) =>
    core.unary("udb.core.webrtc.services.v1.PeerService", "LeaveRoom", request, isReadOnlyRpcName("LeaveRoom"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.webrtc.services.v1.PeerService") return;
  api.list_peers = (request: any, call?: CallOptions) =>
    core.unary("udb.core.webrtc.services.v1.PeerService", "ListPeers", request, isReadOnlyRpcName("ListPeers"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.webrtc.services.v1.RoomService") return;
  api.close_room = (request: any, call?: CallOptions) =>
    core.unary("udb.core.webrtc.services.v1.RoomService", "CloseRoom", request, isReadOnlyRpcName("CloseRoom"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.webrtc.services.v1.RoomService") return;
  api.create_room = (request: any, call?: CallOptions) =>
    core.unary("udb.core.webrtc.services.v1.RoomService", "CreateRoom", request, isReadOnlyRpcName("CreateRoom"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.webrtc.services.v1.RoomService") return;
  api.get_room = (request: any, call?: CallOptions) =>
    core.unary("udb.core.webrtc.services.v1.RoomService", "GetRoom", request, isReadOnlyRpcName("GetRoom"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.webrtc.services.v1.RoomService") return;
  api.list_rooms = (request: any, call?: CallOptions) =>
    core.unary("udb.core.webrtc.services.v1.RoomService", "ListRooms", request, isReadOnlyRpcName("ListRooms"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.webrtc.services.v1.RoomService") return;
  api.update_room = (request: any, call?: CallOptions) =>
    core.unary("udb.core.webrtc.services.v1.RoomService", "UpdateRoom", request, isReadOnlyRpcName("UpdateRoom"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.webrtc.services.v1.TrackService") return;
  api.list_tracks = (request: any, call?: CallOptions) =>
    core.unary("udb.core.webrtc.services.v1.TrackService", "ListTracks", request, isReadOnlyRpcName("ListTracks"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.webrtc.services.v1.TrackService") return;
  api.mute_track = (request: any, call?: CallOptions) =>
    core.unary("udb.core.webrtc.services.v1.TrackService", "MuteTrack", request, isReadOnlyRpcName("MuteTrack"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.webrtc.services.v1.TrackService") return;
  api.publish_track = (request: any, call?: CallOptions) =>
    core.unary("udb.core.webrtc.services.v1.TrackService", "PublishTrack", request, isReadOnlyRpcName("PublishTrack"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.webrtc.services.v1.TrackService") return;
  api.unpublish_track = (request: any, call?: CallOptions) =>
    core.unary("udb.core.webrtc.services.v1.TrackService", "UnpublishTrack", request, isReadOnlyRpcName("UnpublishTrack"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.core.webrtc.services.v1.TurnService") return;
  api.issue_credentials = (request: any, call?: CallOptions) =>
    core.unary("udb.core.webrtc.services.v1.TurnService", "IssueCredentials", request, isReadOnlyRpcName("IssueCredentials"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.activate_catalog = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "ActivateCatalog", request, isReadOnlyRpcName("ActivateCatalog"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.analytical_query = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "AnalyticalQuery", request, isReadOnlyRpcName("AnalyticalQuery"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.apply_migration = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "ApplyMigration", request, isReadOnlyRpcName("ApplyMigration"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.approve_migration_plan = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "ApproveMigrationPlan", request, isReadOnlyRpcName("ApproveMigrationPlan"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.cache_delete = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "CacheDelete", request, isReadOnlyRpcName("CacheDelete"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.cache_get = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "CacheGet", request, isReadOnlyRpcName("CacheGet"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.cache_scan = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "CacheScan", request, isReadOnlyRpcName("CacheScan"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.cache_set = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "CacheSet", request, isReadOnlyRpcName("CacheSet"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.create_materialized_view = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "CreateMaterializedView", request, isReadOnlyRpcName("CreateMaterializedView"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.delete = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "Delete", request, isReadOnlyRpcName("Delete"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.delete_policy = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "DeletePolicy", request, isReadOnlyRpcName("DeletePolicy"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.dismiss_dlq_event = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "DismissDlqEvent", request, isReadOnlyRpcName("DismissDlqEvent"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.document_delete = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "DocumentDelete", request, isReadOnlyRpcName("DocumentDelete"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.document_find = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "DocumentFind", request, isReadOnlyRpcName("DocumentFind"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.document_get = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "DocumentGet", request, isReadOnlyRpcName("DocumentGet"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.document_upsert = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "DocumentUpsert", request, isReadOnlyRpcName("DocumentUpsert"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.drop_resource = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "DropResource", request, isReadOnlyRpcName("DropResource"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.enqueue_outbox_event = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "EnqueueOutboxEvent", request, isReadOnlyRpcName("EnqueueOutboxEvent"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.ensure_project = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "EnsureProject", request, isReadOnlyRpcName("EnsureProject"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.ensure_resource = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "EnsureResource", request, isReadOnlyRpcName("EnsureResource"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.generate_presigned_url = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "GeneratePresignedUrl", request, isReadOnlyRpcName("GeneratePresignedUrl"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.generic_dispatch = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "GenericDispatch", request, isReadOnlyRpcName("GenericDispatch"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.get_admin_summary = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "GetAdminSummary", request, isReadOnlyRpcName("GetAdminSummary"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.get_capabilities = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "GetCapabilities", request, isReadOnlyRpcName("GetCapabilities"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.get_catalog_manifest = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "GetCatalogManifest", request, isReadOnlyRpcName("GetCatalogManifest"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.get_catalog_version = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "GetCatalogVersion", request, isReadOnlyRpcName("GetCatalogVersion"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.get_catalog_versions = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "GetCatalogVersions", request, isReadOnlyRpcName("GetCatalogVersions"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.get_cdc_status = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "GetCdcStatus", request, isReadOnlyRpcName("GetCdcStatus"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.get_dlq_event = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "GetDlqEvent", request, isReadOnlyRpcName("GetDlqEvent"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.get_health_report = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "GetHealthReport", request, isReadOnlyRpcName("GetHealthReport"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.get_migration_status = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "GetMigrationStatus", request, isReadOnlyRpcName("GetMigrationStatus"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.get_saga = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "GetSaga", request, isReadOnlyRpcName("GetSaga"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.graph_mutate = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "GraphMutate", request, isReadOnlyRpcName("GraphMutate"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.graph_query = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "GraphQuery", request, isReadOnlyRpcName("GraphQuery"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.initiate_multipart_upload = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "InitiateMultipartUpload", request, isReadOnlyRpcName("InitiateMultipartUpload"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.lint_policies = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "LintPolicies", request, isReadOnlyRpcName("LintPolicies"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.list_admin_audit_logs = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "ListAdminAuditLogs", request, isReadOnlyRpcName("ListAdminAuditLogs"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.list_dlq_events = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "ListDlqEvents", request, isReadOnlyRpcName("ListDlqEvents"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.list_message_schemas = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "ListMessageSchemas", request, isReadOnlyRpcName("ListMessageSchemas"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.list_migration_runs = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "ListMigrationRuns", request, isReadOnlyRpcName("ListMigrationRuns"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.list_policies = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "ListPolicies", request, isReadOnlyRpcName("ListPolicies"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.list_projects = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "ListProjects", request, isReadOnlyRpcName("ListProjects"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.list_resources = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "ListResources", request, isReadOnlyRpcName("ListResources"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.list_sagas = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "ListSagas", request, isReadOnlyRpcName("ListSagas"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.lookup_message_schema = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "LookupMessageSchema", request, isReadOnlyRpcName("LookupMessageSchema"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.mark_saga_reviewed = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "MarkSagaReviewed", request, isReadOnlyRpcName("MarkSagaReviewed"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.pause_cdc = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "PauseCdc", request, isReadOnlyRpcName("PauseCdc"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.plan_migration = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "PlanMigration", request, isReadOnlyRpcName("PlanMigration"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.preview_cdc_redaction = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "PreviewCdcRedaction", request, isReadOnlyRpcName("PreviewCdcRedaction"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.put_policy = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "PutPolicy", request, isReadOnlyRpcName("PutPolicy"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.quarantine_dlq_event = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "QuarantineDlqEvent", request, isReadOnlyRpcName("QuarantineDlqEvent"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.reload_policies = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "ReloadPolicies", request, isReadOnlyRpcName("ReloadPolicies"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.replay_dlq_event = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "ReplayDlqEvent", request, isReadOnlyRpcName("ReplayDlqEvent"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.resume_cdc = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "ResumeCdc", request, isReadOnlyRpcName("ResumeCdc"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.retry_saga_compensation = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "RetrySagaCompensation", request, isReadOnlyRpcName("RetrySagaCompensation"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.rollback_catalog = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "RollbackCatalog", request, isReadOnlyRpcName("RollbackCatalog"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.scan_projection_drift = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "ScanProjectionDrift", request, isReadOnlyRpcName("ScanProjectionDrift"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.select = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "Select", request, isReadOnlyRpcName("Select"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.stage_catalog = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "StageCatalog", request, isReadOnlyRpcName("StageCatalog"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.step_down_cdc_leader = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "StepDownCdcLeader", request, isReadOnlyRpcName("StepDownCdcLeader"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.time_series_query = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "TimeSeriesQuery", request, isReadOnlyRpcName("TimeSeriesQuery"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.time_series_write = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "TimeSeriesWrite", request, isReadOnlyRpcName("TimeSeriesWrite"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.upsert = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "Upsert", request, isReadOnlyRpcName("Upsert"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.validate_catalog = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "ValidateCatalog", request, isReadOnlyRpcName("ValidateCatalog"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.vector_hybrid_search = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "VectorHybridSearch", request, isReadOnlyRpcName("VectorHybridSearch"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.vector_search = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "VectorSearch", request, isReadOnlyRpcName("VectorSearch"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.vector_upsert = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "VectorUpsert", request, isReadOnlyRpcName("VectorUpsert"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
  api.verify_admin_audit_log = (request: any, call?: CallOptions) =>
    core.unary("udb.services.v1.DataBroker", "VerifyAdminAuditLog", request, isReadOnlyRpcName("VerifyAdminAuditLog"), call);
});
SERVICE_METHOD_INSTALLERS.push((core, api) => {
  if (api.serviceFull !== "udb.services.v1.DataBroker") return;
