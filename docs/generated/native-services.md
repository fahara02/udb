...
Contract version `1.0.0` · 15 native services.
...
| `storage` | Storage | storage | yes | postgres, object_store | 7 | control-plane |
| `tenant` | Tenants | tenant | yes | postgres | 6 | control-plane |
| `webrtc_peer` | WebRTC Peers | realtime | yes | postgres | 4 | control-plane, peer |
