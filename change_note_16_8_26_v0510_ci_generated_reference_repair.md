...
The first execution of that expanded repair contract, CI run `31924007614`,
emitted artifact `9257364918` with the expected eight SDK outputs and no
unrelated files. Those CI-generated bytes are now checked in for the clean
verification run.
